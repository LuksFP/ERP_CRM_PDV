...
export const PHARMACY_CONFIG: TenantConfig = {
  ...
  plan: {
    ...
    limits: {
      ...
      maxBranches: 2,
      maxProductsSKU: 0,
      modules: ['dashboard', 'inventory', 'pdv', 'financial', 'fiscal', 'settings'],
  ...
  modules: {
    enabled: ['dashboard', 'inventory', 'pdv', 'financial', 'fiscal', 'settings'],
    disabled: [],
...
export const SUPERMARKET_CONFIG: TenantConfig = {
  ...
  plan: {
    ...
    limits: {
      ...
      maxBranches: 5,
      maxProductsSKU: 0,
      modules: ['dashboard', 'inventory', 'pdv', 'crm', 'financial', 'fiscal', 'purchasing', 'settings'],
      customFieldsEnabled: true,
      apiAccess: true,
  ...
  modules: {
    enabled: ['dashboard', 'inventory', 'pdv', 'crm', 'financial', 'fiscal', 'purchasing', 'settings'],
    disabled: [],
    locked: [],
  },
